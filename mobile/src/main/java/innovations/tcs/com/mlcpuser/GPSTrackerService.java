...
/**
 * Created by 1115394 on 11/16/2016.
 */
...
public class GPSTrackerService extends Service implements LocationListener {
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(mContext, CAMERA);
...
//                        Log.i("GPSTrackerService", "no permission");
                        return null;
                    }

//                    Log.i("GPSTrackerService", "Have Permission");
    ...
    public void showSettingsAlert(){
        ...
        builder.setMessage("Please enable your GPS by clicking on settings button!");
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                alert.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(mContext.getResources().getColor(R.color.colorPrimary));
            }
        });
